...
public class Tints {
    ...
    public static Drawable tint(Context context, Drawable drawable, Tint tint) {
        return tint(drawable, tint.getColor(context));
    }

    public static Drawable tint(Context context, @DrawableRes int drawableId, Tint tint) {
    ...
    private static Tint fromAttr(final String attrName) {
        return new Tint() {
            @Override
    ...
    public static Tint fromColorList(final ColorStateList color) {
        return new Tint() {
            @Override
            public ColorStateList getColor(Context context) {
                return color;
    ...
    public static Tint withAlpha(final Tint tint, final int alpha) {
        return new Tint() {
            @Override
            public ColorStateList getColor(Context context) {
    ...
    public static Tint withDisabledAlpha(Tint tint) {
